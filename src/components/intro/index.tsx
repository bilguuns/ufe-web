...
const Intro = ({introData}: any) => {
    ...
    const intros = introData.childIntros.length > 0 ? introData.childIntros : introData.intros;
    const introPost = introData.introPosts.length > 0 ? introData.introPosts[0] : null;
